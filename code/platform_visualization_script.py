...
#     https://colab.research.google.com/drive/1NWdyX8kOLDTZVE8vOcgEPmOWX-Pwnbd5
# """
...
def plot_navigation(file_name, lon_col = 'Longitude', lat_col = 'Latitude', alt_col = 'Altitude',
  ...
  #df_gpd_pc = df_gpd.to_crs(crs.proj4_init)
  ...
  #ax.set_title('FIREX-AQ: Racetrack Flight Path',fontsize=25,weight='bold')  # Add a title
